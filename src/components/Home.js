    ...
    <>
      ...
      <section className='container-reservation'>
        <div className='section-reservation'>
          ...
          <h2>Trouvez et réservez <span style={{color: 'red'}}>rapidement</span> votre place en crèche !</h2>
          <button className='btn-home-reservation'>Je réserve !</button><button className='btn-home-calendar'> Calendrier</button>
        </div>
